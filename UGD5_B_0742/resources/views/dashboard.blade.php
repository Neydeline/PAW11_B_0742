<!DOCTYPE html>
    <html lang="en">
        <head>
            ...
            <title>Amsang Tech | UGD5_B_0742</title>
        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <a href="#" class="brand-link">
                    ...
                    <span class="brand-text font-weight-light">Amsang Tech</span></a>
                ...
                <div class="info">
                    <a href="#" class="d-block">Neydeline Dorma</a>
                </div>
            </div>
    ...
    <footer class="main-footer">
        <!-- To the right -->
        <div class="float-right d-none d-sm-inline"> 200710742 </div>
        <!-- Default to the left -->
